...
Written from inside JavaScript governance. The author co-edits ECMA-402, champions Intl.MessageFormat,
and has co-chaired TC39 and championed Temporal and Intl.DurationFormat, and the site explains standards bodies and specs as someone who
...
- Roles shown as fact: ECMA-402 co-editor and Intl.MessageFormat champion. Past roles (TC39
  co-chair, Temporal and Intl.DurationFormat champion, Node.js core contributor, Electron
  maintainer and a former employer) sit in their own list on the home page.
